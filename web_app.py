...
def prepare_mlp_cnn_data(data, pipeline):
    """Prepare data for MLP+1D-CNN model using the same preprocessing pipeline as other models"""
    try:
        # Create a copy to avoid modifying the original data
        data_copy = data.copy()
        ...
        # Spectral data: remaining columns (should be 1400 after preprocessing)
        ...
        if st.session_state.data is not None and st.session_state.models_loaded:
            ...
            if pipeline is not None:
                ...
                with arch_col2:
                    ...
                    # Create a complete hybrid architecture diagram using simpler approach
                    st.markdown("""
                    ...
                    # Processing Branches
                    st.markdown("**🔄 Processing Branches**")
